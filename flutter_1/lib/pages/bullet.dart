...
class Bullet extends StatefulWidget {
  const Bullet({super.key, required String username, required String email});
...
class BulletState extends State<Bullet> {
  ...
  final String _storageKey = 'bullet_videos_v3';
  ...
  Future<void> _loadVideos() async {
    ...
    final defaultVideos = [
      {
        'url': 'assets/videos/bullet1.mp4',
        'thumbnail': 'assets/images/bullet.png',
        'title': 'Royal Enfield Bullet Introduction',
        'isAsset': true,
        'isDefault': false,
      },
    ];
      ...
      if (savedVideos != null) {
        ...
        for (var video in decodedVideos) {
          ...
          Map<String, dynamic> videoMap = {
            'url': video['url'] ?? '',
            'thumbnail': video['thumbnail'] ?? 'assets/images/bullet.png',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Royal Enfield Bullet Videos"),
