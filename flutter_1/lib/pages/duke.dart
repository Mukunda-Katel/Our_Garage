...
class Duke extends StatefulWidget {
  const Duke({super.key, required String username, required String email});

  @override
  DukeState createState() => DukeState();
}

class DukeState extends State<Duke> {
  ...
  final String _storageKey = 'duke_videos_v3';
  ...
  Future<void> _loadVideos() async {
    ...
    final defaultVideos = [
      {
        'url': 'assets/videos/duke1.mp4',
        'thumbnail': 'assets/images/ktm.png',
        'title': 'KTM Duke Introduction',
        'isAsset': true,
        'isDefault': false,
      },
    ];
      ...
      if (savedVideos != null) {
        ...
        for (var video in decodedVideos) {
          ...
          Map<String, dynamic> videoMap = {
            'url': video['url'] ?? '',
            'thumbnail': video['thumbnail'] ?? 'assets/images/ktm.png',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("KTM Duke Videos"),
