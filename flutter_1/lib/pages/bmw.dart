...
class BMW extends StatefulWidget {
  ...
  const BMW({super.key, this.username = '', this.email = ''});

  @override
  BMWState createState() => BMWState();
}

class BMWState extends State<BMW> {
  ...
  final String _storageKey = 'bmw_videos_v3';
  ...
  Future<void> _loadVideos() async {
    ...
    final defaultVideos = [
      {
        'url': 'assets/videos/bmw1.mp4',
        'thumbnail': 'assets/images/bmw.png',
        'title': 'BMW Introduction',
        'isAsset': true,
        'isDefault': false,
      },
    ];
      ...
      if (savedVideos != null) {
        ...
        for (var video in decodedVideos) {
          ...
          Map<String, dynamic> videoMap = {
            'url': video['url'] ?? '',
            'thumbnail': video['thumbnail'] ?? 'assets/images/bmw.png',
