...
class Suzuki extends StatefulWidget {
  const Suzuki({super.key, required String username, required String email});

  @override
  SuzukiState createState() => SuzukiState();
}

class SuzukiState extends State<Suzuki> {
  ...
  final String _storageKey = 'suzuki_videos_v3';
  ...
  Future<void> _loadVideos() async {
    ...
    final defaultVideos = [
      {
        'url': 'assets/videos/suzuki1.mp4',
        'thumbnail': 'assets/images/suzuki.png',
        'title': 'Suzuki Introduction',
        'isAsset': true,
        'isDefault': false,
      },
    ];
      ...
      if (savedVideos != null) {
        ...
        for (var video in decodedVideos) {
          ...
          Map<String, dynamic> videoMap = {
            'url': video['url'] ?? '',
            'thumbnail': video['thumbnail'] ?? 'assets/images/suzuki.png',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Suzuki Videos"),
